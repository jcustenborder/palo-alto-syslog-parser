...
import com.github.jcustenborder.netty.paloalto.ImmutableAuthenticationLogMessage.Builder;
...
public class AuthenticationLogParser
  ...
  @Override
  public AuthenticationLogMessage parse(Message message, String[] fields) {
